...
use App\Http\Controllers\Admin\FooterHelplLinkController;
...
Route::group(['middleware' => ['auth'], 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::resource('footer-useful-links', FooterUsefullLinkController::class);

    /** Footer Help Links Route */
    Route::resource('footer-help-links', FooterHelplLinkController::class);
